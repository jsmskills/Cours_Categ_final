...
public class Fxml_coursController implements Initializable {
  ...
  pane3.setVisible(true);
    ...
    public void addButtonModifToTable() {
                        ...
                        btn.setOnAction((ActionEvent event) -> {
                            ...
                            //l'interface apres avoir cliqué sur le bouton
                             ...
                             pic.setVisible(false);
                              ...
                              date_picker_modif.setValue(LocalDate.parse(String.valueOf(coursCourant.getDuree())));
        ...
        colBtn.setCellFactory(cellFactory); //kol madzid ligne (ajout) yzidlek bouton modifier
